...
| --- | --- | --- |
| `store` | Store | `store_version`, `store_capabilities`, `store_capabilities_json`, `store_blob_digest`, `store_policy_get`, `store_policy_set`, `store_maintenance_status`, `store_maintenance_policy_set`, `store_maintenance_run` |
