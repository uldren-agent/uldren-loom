...
| --- | --- | --- |
| `store` | Store | `store_version`, `store_capabilities`, `store_capabilities_json`, `store_blob_digest`, `store_policy_get`, `store_policy_set`, `store_bundle_import`, `store_maintenance_status`, `store_maintenance_policy_set`, `store_maintenance_run` |
...
| `vector` | Vector | `vector_create`, `vector_upsert`, `vector_upsert_source`, `vector_get`, `vector_source_text`, `vector_embedding_model`, `vector_ids`, `vector_metadata_index_keys`, `vector_create_metadata_index`, `vector_drop_metadata_index`, `vector_delete`, `vector_search`, `vector_search_policy`, `vector_text_upsert`, `vector_workspace_configure_json` |
| `columnar` | Columnar | `columnar_create`, `columnar_append`, `columnar_scan`, `columnar_columns`, `columnar_rows`, `columnar_select`, `columnar_aggregate`, `columnar_compact`, `columnar_inspect`, `columnar_source_digest`, `columnar_import_arrow`, `columnar_import_parquet` |
...
| `lanes` | Store-backed Lane coordination state | `lanes_create`, `lanes_get`, `lanes_list`, `lanes_update`, `lanes_closeout`, `lanes_ticket_add`, `lanes_ticket_remove`, `lanes_ticket_transfer`, `lanes_delete`, `lanes_cleanup` |
...
| `chat` | Store-backed Studio profile | `chat_channels`, `chat_create_channel`, `chat_rename_channel`, `chat_fetch_events`, `chat_messages`, `chat_cursor`, `chat_presence`, `chat_post_message`, `chat_post_message_bytes`, `chat_edit_message`, `chat_edit_message_bytes`, `chat_redact_message`, `chat_emoji_list`, `chat_emoji_register`, `chat_emoji_unregister`, `chat_add_reaction`, `chat_remove_reaction`, `chat_create_thread`, `chat_create_task`, `chat_claim_task`, `chat_complete_task`, `chat_invoke_agent`, `chat_invoke_agent_bytes`, `chat_agent_reply`, `chat_request_handoff`, `chat_update_cursor`, `chat_set_presence` |
...
| `document` | Document | `document_put_text`, `document_get_text`, `document_put_binary`, `document_get_binary`, `document_delete`, `document_delete_collection`, `document_list_binary`, `document_list_collections`, `document_query`, `document_replace_text` |
...
| `sql` | Sql | `sql_exec`, `sql_exec_result`, `sql_query` (read-only), `sql_commit`, `sql_read_table`, `sql_read_table_at`, `sql_index_scan`, `sql_index_scan_at`, `sql_diff`, `sql_table_diff`, `sql_blame`, `sql_list_databases` |
