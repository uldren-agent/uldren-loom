...
use loom_core::{
    ...
    cas_get, cas_has, cas_list, cas_put, doc_create_index, doc_delete, doc_delete_collection,
    doc_drop_index, doc_find, doc_index_statuses, doc_list_indexes, doc_query, doc_rebuild_index,
