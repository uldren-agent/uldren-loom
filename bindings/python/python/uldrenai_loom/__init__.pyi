...
def audit_config_show_json(path: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def audit_config_set_json(path: str, retention_days: int | None = None, legal_hold: bool | None = None, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def audit_list_json(path: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def audit_view_json(path: str, record: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def certificate_list_json(path: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def certificate_import_json(path: str, name: str, cert_chain_pem: bytes, private_key_pem: bytes, trust_bundle_pem: bytes | None = None, force: bool = False, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def certificate_export(path: str, name: str, include_cert_chain: bool, include_private_key: bool, include_trust_bundle: bool, force: bool = False, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> bytes: ...
def certificate_generate_self_signed_json(path: str, name: str, dns_names: list[str], ip_addresses: list[str], cn: str | None = None, days: int = 365, algorithm: str = "p256", force: bool = False, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def certificate_remove_json(path: str, name: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def certificate_audit_json(path: str, name: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def network_access_list_json(path: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def network_access_set_json(path: str, name: str, description: str | None, default_action: str, rules_json: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def network_access_remove_json(path: str, name: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...
def network_access_audit_json(path: str, name: str, store_passphrase: str | None = None, principal: str | None = None, principal_passphrase: str | None = None) -> str: ...

def lifecycle_define_standard_json(path: str, workspace: str, kind: str, version: str, completion_predicate_digest: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def lifecycle_define_json(path: str, workspace: str, definition: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def lifecycle_instantiate_json(path: str, workspace: str, instance_id: str, definition_id: str, subject_refs: list[str], store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def lifecycle_transition_json(path: str, workspace: str, instance_id: str, transition_id: str, to_stage_id: str, actor_principal_id: str | None, gate_evaluations_json: str, snapshot_digest: str | None = None, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def refs_reconcile_json(path: str, workspace: str, max: int, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
...
def tickets_project_settings_get_json(path: str, workspace: str, ticket_workspace_id: str, project_id: str, include_contracts: bool = False, passphrase: str | None = None) -> str: ...

def tickets_project_settings_set_json(path: str, workspace: str, ticket_workspace_id: str, project_id: str, default_projection: str | None = None, enable_projections_json: str = "[]", disable_projections_json: str = "[]", actor_enforcement: str | None = None, project_owner_principal: str | None = None, clear_project_owner_principal: bool = False, acceptance_authorities_json: str | None = None, acceptance_evidence_enforcement: bool | None = None, required_acceptance_evidence_keys_json: str | None = None, required_acceptance_reviews_json: str | None = None, owner_contract_summary: str | None = None, owner_contract_details: str | None = None, worker_contract_summary: str | None = None, worker_contract_details: str | None = None, expected_root: str | None = None, passphrase: str | None = None) -> str: ...
...
def chat_post_message_bytes_json(path: str, workspace: str, chat_workspace_id: str, channel_id: str, message_id: str, thread_id: str | None, body: bytes, expected_entity_tag: str | None = None, passphrase: str | None = None) -> str: ...
...
def chat_edit_message_bytes_json(path: str, workspace: str, chat_workspace_id: str, channel_id: str, message_id: str, body: bytes, expected_entity_tag: str | None = None, passphrase: str | None = None) -> str: ...
...
def chat_invoke_agent_bytes_json(path: str, workspace: str, chat_workspace_id: str, channel_id: str, invocation_id: str, agent_principal: str, source_message_ids_json: str, prompt: bytes, expected_entity_tag: str | None = None, passphrase: str | None = None) -> str: ...
...
def apply_cbor(path: str, request: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes:
    """Execute generated ``Exec.apply_cbor`` with an authenticated generated session."""
    ...

def sql_exec_result(path: str, workspace: str, db: str, sql: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes:
    """Execute generated ``Sql.sql_exec_result`` and return canonical result bytes."""
    ...

def columnar_import_arrow(path: str, workspace: str, name: str, payload: bytes, target_segment_rows: int, replace: bool, dry_run: bool, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def columnar_import_parquet(path: str, workspace: str, name: str, payload: bytes, target_segment_rows: int, replace: bool, dry_run: bool, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def vector_text_upsert(path: str, request: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def vector_workspace_configure_json(path: str, workspace: str, request_json: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def studio_reindex_json(path: str, workspace: str, profile: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def studio_revisions_rebuild_json(path: str, workspace: str, profile: str, dry_run: bool, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def audit_compact(path: str, through_seq: int, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def store_bundle_import(path: str, bundle: bytes, dry_run: bool, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def store_maintenance_status(path: str, request: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def store_maintenance_policy_set(path: str, update: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def store_maintenance_run(path: str, request: bytes, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> bytes: ...
def inference_instance_create_json(path: str, workspace: str, name: str, model: str, kind: str, runtime: str, preset: str | None, settings_json: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def inference_instance_update_json(path: str, workspace: str, name: str, preset: str | None, settings_json: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def inference_instance_delete_json(path: str, workspace: str, name: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_listener_configure_json(path: str, request_json: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_listener_list_json(path: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_listener_set_enabled_json(path: str, listener_id: str, enabled: bool, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_listener_remove_json(path: str, listener_id: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_web_route_list_json(path: str, listener_id: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_web_route_set_json(path: str, request_json: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
def serve_web_route_remove_json(path: str, listener_id: str, route_id: str, store_passphrase: str | None = None, auth_principal: str | None = None, auth_passphrase: str | None = None) -> str: ...
...
def identity_force_detach_authority_json(
    path: str,
    ...
    """Force-detach identity authority and return the JSON mutation report."""
    ...

def identity_replicate_authority_json(
    path: str,
    source: str,
...
def identity_configure_authority_replication_json(
    path: str,
    id: str,
    source: str,
    disabled: bool,
    ...
    """Configure identity authority replication and return the JSON mutation report."""
    ...

def identity_remove_authority_replication_json(
    path: str,
    id: str,
    passphrase: str | None = None,
    auth_principal: str | None = None,
    ...
    """Remove identity authority replication and return the JSON mutation report."""
    ...
...
def archive_import(
    ...
    src_path: str,
    kind: str,
    gzip_output_path: str | None = None,
    commit: bool = False,
    author: str | None = None,
    message: str | None = None,
    dry_run: bool = False,
