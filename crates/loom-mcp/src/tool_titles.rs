...
const TITLE_REPLACEMENTS: &[(&str, &str)] = &[
    ...
    ("store_bundle_import", "Store: Import a bundle"),
    ...
    ("vector_text_upsert", "Vector: Upsert embedded text"),
    (
        "vector_workspace_configure_json",
        "Vector: Configure workspace JSON",
    ),
    ...
    ("columnar_import_arrow", "Columnar: Import Arrow IPC"),
    ("columnar_import_parquet", "Columnar: Import Parquet"),
...
pub const TOOL_TITLES: &[(&str, &str)] = &[
    ...
    ("chat_post_message_bytes", "Chat: post a binary message"),
    ("chat_edit_message", "Chat: edit a message"),
    ("chat_edit_message_bytes", "Chat: edit a binary message"),
    ...
    (
        ...
        "Chat: invite an agent participant with a binary prompt",
    ),
    ...
    ("sql_exec_result", "SQL: run statements with result"),
    ("sql_query", "SQL: run a read-only query"),
