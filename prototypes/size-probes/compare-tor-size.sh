#!/usr/bin/env bash
#
# Focused footprint report for embedded Arti Tor routing and onion-service support.
...
echo
echo "Tor size-probes"
echo "----------------------------------------------------------------------------------------------------------------"
printf '  %-20s %-20s %14s   %-12s  %-7s  %s\n' "probe" "feature" "size" "vs baseline" "deps" "point"
echo "----------------------------------------------------------------------------------------------------------------"
row baseline baseline "empty binary control"
row arti-onion tor_arti_onion "embedded Tor routing plus onion-service server"
